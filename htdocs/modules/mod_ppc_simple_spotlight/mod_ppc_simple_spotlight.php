...
if ($params->get('show20')){		
	...
	<a href="#" class="ssprev"><span id="prev<?php echo $module->id?>"><img src="modules/mod_ppc_simple_spotlight/img/button/prev<?php echo $imgbutton ;?>.png" title="Previous" alt="Previous" /></span></a> 
	<a href="#" class="ssnext"><span id="next<?php echo $module->id?>"><img src="modules/mod_ppc_simple_spotlight/img/button/next<?php echo $imgbutton ;?>.png" title="Next" alt="Next" /></span></a>
    </div>
    <?php endif; ?>
</div>
